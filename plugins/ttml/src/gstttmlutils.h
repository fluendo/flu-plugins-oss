...
extern const GstTTMLToken *GstTTMLUtilsTokensUnicodeBIDI;
extern const GstTTMLToken *GstTTMLUtilsTokensDirection;
extern const GstTTMLToken *GstTTMLUtilsTokensWritingMode;
...
#define gst_ttml_utils_enum_parse(name, type)                                 \
  (GstTTML##type)                                                             \
      gst_ttml_utils_enum_parse_func (name, GstTTMLUtilsTokens##type)
...
/* Flags list -> value (like enums, but allows merging multiple values in one
 * line */
#define gst_ttml_utils_flags_parse(name, type)                                \
  (GstTTML##type)                                                             \
      gst_ttml_utils_flags_parse_func (name, GstTTMLUtilsTokens##type)
...
int gst_ttml_utils_enum_parse_func (
    const gchar *name, const GstTTMLToken *list);
const gchar *gst_ttml_utils_enum_name_func (int val, const GstTTMLToken *list);
int gst_ttml_utils_flags_parse_func (
    const gchar *name, const GstTTMLToken *list);
const gchar *gst_ttml_utils_flags_name_func (
    int val, const GstTTMLToken *list);
...
GstTTMLNodeType gst_ttml_utils_node_type_parse (
    const gchar *ns, const gchar *name);
void gst_ttml_utils_memdump_buffer (
...
#else
#define GST_TTML_UTILS_MEMDUMP_BUFFER_OBJECT(object, msg, buffer)             \
  G_STMT_START {}                                                             \
  G_STMT_END
#define GST_TTML_UTILS_MEMDUMP_BUFFER(msg, buffer)                            \
  G_STMT_START {}                                                             \
